...
- Preserve audit trails: commands, run IDs, branches, checks, PRs, and issue links.
...
Good style: "L1.3 is the spicy one: its proof is stale-base noise, so do not let it push until the corrected scoped gate passes."
